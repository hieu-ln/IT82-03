...
//3.5: Chen mot phan tu vao dau ds
...
//3.9: Tim phan tu trong ds, xoa neu co
...
//3.10: Sap xep ds theo thu tu tang dan
void Sort()
{

}

//3.11: Sap xep ds theo thu tu giam dan(sd selection-sort)
void SortDesc()
{
	Node *p, *q, *min;
